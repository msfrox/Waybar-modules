...
//   ~/.cache/waybar-modules/claude-usage-state.json
// which this reads, and it owns the settings file
//   ~/.config/waybar-modules/claude-usage.json
...
PanelWindow {
    ...
    readonly property string statePath: Quickshell.env("HOME") + "/.cache/waybar-modules/claude-usage-state.json"
    readonly property string settingsPath: Quickshell.env("HOME") + "/.config/waybar-modules/claude-usage.json"
